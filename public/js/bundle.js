...
exports.logoutHandler = exports.loginHandler = exports.changePasswordHandler = void 0;
...
var changePasswordHandler = /*#__PURE__*/function () {
  ...
  return function changePasswordHandler() {
...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_updateData, type) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "".concat(type.toUpperCase(), " update in successfully!"));
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoic2hqbmVldm4iLCJhIjoiY2w4MzdjdnlhMDNmaTN3azBqZTI1eHgwZiJ9.hq3n1akmQ218pON_NAv8DQ";
  var map = new mapboxgl.Map({
    container: "map",
    // container ID
    style: "mapbox://styles/shjneevn/cl837glbg001p16s8hhl7f82d",
    // style URL
    scrollZoom: true //   center: [-118, 34], // starting position [lng, lat]
...
var updateUserPassword = document.querySelector(".form-user-settings"); //LOGIN
